...
{
    class EncounteredPerson : IPerson
    {
        ...
        public SickEncounter Encounter { get; private set; }

        public DateTime IsolationDate => Encounter.DateReported;
        public EncounteredPerson(SickEncounter encounter, IPerson person)
        {
            this._person = person;
